...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/pimcore/static5/css/admin.css?_dc=<?php echo \Pimcore\Version::$revision ?>" />
</head>
...
<div id="pimcore_loading">
    <img class="loading" src="/pimcore/static5/img/loading-white-bg.gif?_dc=<?php echo \Pimcore\Version::$revision ?>" />
</div>
...
<?php foreach ($scriptLibs as $scriptUrl) { ?>
    <script type="text/javascript" src="/pimcore/static5/js/<?php echo $scriptUrl ?>?_dc=<?php echo \Pimcore\Version::$revision ?>"></script>
<?php } ?>
...
<script type="text/javascript" src="/pimcore/static5/js/pimcore/startup.js?_dc=<?php echo \Pimcore\Version::$revision ?>"></script>
</body>
</html>